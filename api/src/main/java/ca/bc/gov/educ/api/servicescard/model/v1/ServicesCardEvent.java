...
@Builder
@Entity
@Table(name = "SERVICES_CARD_EVENT")
@Data
@DynamicUpdate
public class ServicesCardEvent {
  @Id
  ...
  public static class ServicesCardEventBuilder {
    byte[] eventPayloadBytes;

    public ServicesCardEvent.ServicesCardEventBuilder eventPayload(String eventPayload) {
