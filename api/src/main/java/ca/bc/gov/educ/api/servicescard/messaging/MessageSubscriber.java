...
import ca.bc.gov.educ.api.servicescard.properties.ApplicationProperties;
...
public class MessageSubscriber {
  ...
  public void subscribe() throws InterruptedException, TimeoutException, IOException {
    SubscriptionOptions options = new SubscriptionOptions.Builder().durableName("services-card-api-consumer").build();
    connection.subscribe(SERVICES_CARD_API_TOPIC.toString(), "services-card-api", this::onServicesCardTopicMessage, options);
  }
   ...
   */
  private void onServicesCardTopicMessage(Message message) {
